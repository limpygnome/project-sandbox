...
import com.limpygnome.projectsandbox.website.world.Map;
...
public class Vertices
{
     ...
     * @return 
     */
    public static Vertices buildTileVertices(Map map, int tileX, int tileY)
    {
        ...
        return new Vertices(position, 0.0f, ts, ts);
    }
